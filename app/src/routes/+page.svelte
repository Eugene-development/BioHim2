                    ...
                    <div class="flex flex-1 items-center">
                        <div class="flex w-full items-center justify-between md:w-auto">
                            <a href="#">
                                ...
                                <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark.svg?from-color=teal&from-shade=200&to-color=cyan&to-shade=400&toShade=400" alt="">
                            </a>
...
<!--            </div>-->
        ...
        <main>
            <div class="bg-[url('https://egevpare.ru/wp-content/uploads/2022/04/1625178061_49-kartinkin-com-p-khimiya-fon-krasivie-foni-52.png')]  py-12 sm:pt-8 sm:pb-48 md:pb-24 lg:overflow-hidden ">
                <div class="mx-auto max-w-7xl lg:px-8">

                    <div class="lg:grid lg:grid-cols-2 lg:gap-4">
                        <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                            <div class="lg:py-24 bg-main bg-opacity-60 px-4">
                                <a href="#" class="inline-flex items-center rounded-full bg-black p-1 pr-2 text-white hover:text-gray-200 sm:text-base lg:text-sm xl:text-base">
                                    <span class="rounded-full bg-gradient-to-br from-blue-500 to-green-600 px-3 py-0.5 text-sm font-semibold leading-5 text-white">Перекись водорода</span>
                                ...
                                <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">Предлагаем техническую и медицинскую перекись водорода в IBC-контейнерах по оптовым ценам</p>
                                <div class="mt-10 sm:mt-12">
                                    <form action="#" class="sm:mx-auto sm:max-w-xl lg:mx-0">
                                        <div class="sm:flex">
                                            <div class="min-w-0 flex-1">
                                                <label for="email" class="sr-only">Ваша почта</label>
                                                <input id="email" type="email" placeholder="Ваша почта" class="block w-full rounded-md border-0 px-4 py-3 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900">
                                            </div>
                                            <div class="mt-3 sm:mt-0 sm:ml-3">
                                                <button type="submit" class="block w-full rounded-md bg-gradient-to-r from-teal-500 to-cyan-600 py-3 px-4 font-medium text-white shadow hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900">Запрос цены</button>
                                            </div>
                                        </div>
                                        <p class="mt-3 text-sm text-gray-300 sm:mt-4">Отправьте вашу почту и получите актуальную цену на перекись водорода.</p>
                                    </form>
                                </div>
                            </div>
                        </div>
                        <div class="mt-12 -mb-16 sm:-mb-48 lg:relative lg:m-0">
                            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
                                ...
                                <img class="w-full lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none" src="" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mx-auto max-w-md px-4 pt-12 sm:max-w-7xl sm:px-6 lg:px-8 lg:pt-16">
                <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div class="space-y-8 xl:col-span-1">
                        <img class="h-10" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=gray&shade=300" alt="Company name">
