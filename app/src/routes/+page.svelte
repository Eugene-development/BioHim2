...
<svelte:head>
	<title>Техническая перекись водорода крупным и мелким оптом</title>
	<meta
		name="description"
		content="Оптовая продажа технической перекиси водорода от производителя"
	/>
</svelte:head>
						...
						>
							<div class=" lg:py-48 py-12 bg-main bg-opacity-60 px-2">
								...
								<p class="mt-8 text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
									Техническая перекись водорода в IBC-контейнерах по оптовым ценам от заводов
									производителей с доставкой или самовывозом. Вся продукция сопровождается
				...
				>
					...
					<section aria-labelledby="details-heading">
						<div class="text-center">
							...
							<p class="mx-auto mt-5 max-w-prose text-xl text-gray-700">
								Перекись водорода для медицины и техническая перекись водорода применяются в разных
						...
						<div class="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
							...
							<div>
								...
								<p class="mt-8 text-base text-gray-700">
									<strong>Перекись водорода для медицины</strong> применяется в медучреждениях и лабораториях
