<script>
	...
	const main_text =
		'Техническая и медицинская перекись водорода в IBC-контейнерах по оптовым ценам от заводов производителей с доставкой или самовывозом. Вся продукция сопровождается сертификатами качества.';
	const a_text =
	...
	const main_text_v2 =
		'Техническая перекись водорода в IBC-контейнерах по оптовым ценам от заводов производителей с доставкой или самовывозом. Вся продукция сопровождается сертификатами качества.';
	const a_text_v2 =
								...
								<div class="flow-root bg-main px-6 pb-8">
									<div class="-mt-6">
										...
										<p class="mt-5 text-base text-gray-50">
											Перекись водорода для мед. нужд (35‑40%) и техническая перекись водорода марки
											А(35‑40%) и Б(30‑40%).
										</p>
									</div>
								</div>
